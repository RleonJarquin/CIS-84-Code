...
public class seatReservation 
{
    ...
    public void setDefault()
    {
        ...
        //Addtional note the Input for state is 0 for Seated or 1 for reserved Might change this to only be reserved and not seated/Reserved
    //Have to update set Seat because it is defaulting to Seated instead of reserved
    public void setSeat(int seatNumber,String name,double Price)
    {
        //go from index position 0 to 97 

        // Random thought. I should not reset the seatNumber value but is should use another variable. Example Seat Index
        int index = 0;
        ...
        else
        {
            ...
            // If the seat number state is "Seated" or it is "Reserved" then notify user that they picked a wrong seat.
    ...
    public String getReservedSeatedSeats2()
    {
        ...
        for (int x = 0; x < 99; x++)
        {
            if(seatStatusArray[x] == reserved ||seatStatusArray[x] == seated)
            {
                output = output + "The seat Number is: " + seatNumberArray[x] + " The seat State is: " + seatStatusArray[x] + " The name of the person is: " + seatNameArray[x] + " The seat price paid for is: " + seatPriceArray[x] + "\n";
                seatCounter = seatCounter + 1;
            }
        }
        output = output + "The number of Reserved/Seated seats is: " + seatCounter;
    ...
    public String getAllValues()
    {
        ...
        //Helper function to see if the seat is already taken or does not exist  Currently not being implemented 
    ...
    //If there are there are reserved or seated seats then the the seats are able to be updated/ (allows that status to be changed)
...
//Pick a number to see if the seat state update the seat 0 for Reserved. 1 for Seated. 2 for Available 
//2 inputs from the fcn 1 state (options 0/1/2)
    public void changeSeatStatus(int state,int seatNumber)
    {
        //If the seat number is greater tha 199 or is lower than 101 then execute this code
